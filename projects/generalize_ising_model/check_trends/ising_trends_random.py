...
if __name__ == '__main__':
    ...
    sizes = [500,1000]
    main_path = r"/Users/npopiel2/Desktop/Popiel/check_ising/"
    temperature_params =[(1.8,600,50),(2,850,50)]# Params for 5,10,25,100,250 (-3,4,50),(-1,8,50),(0,12,50), (1,100,50), (1.3,200,50),
    no_simulations = 4000
    thermalize_time =0.3
