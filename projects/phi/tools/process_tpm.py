...
for state in brain_states:
    ...
    new_path_list_eps = [#'/home/user/Desktop/data_phi/Propofol/' + state + '/Auditory_parcellation_5',
                    #'/home/user/Desktop/data_phi/Propofol/' + state + '/CinguloOperc_parcellation_5',
                    '/home/user/Desktop/data_phi/Propofol/' + state + '/Default_parcellation_5/ts_Default_parcellation_5_Sub1.csv']
                    #'/home/user/Desktop/data_phi/Propofol/' + state + '/DorsalAttn_parcellation_5',
                    #'/home/user/Desktop/data_phi/Propofol/' + state + '/FrontoParietal_parcellation_5',
                    #'/home/user/Desktop/data_phi/Propofol/' + state + '/RetrosplenialTemporal_parcellation_5',
                    #'/home/user/Desktop/data_phi/Propofol/' + state + '/SMhand_parcellation_5',
    ...
    '''
    f_eps = '/home/user/Desktop/data_phi/Propofol/Awake/Default_parcellation_5/eps'
    f_og = '/home/user/Desktop/data_phi/Propofol/Awake/Default_parcellation_5/og'

    count = 1

    for file in new_path_list_eps:

        ts = load_matrix(file)
        empirical_tpm_eps(ts,f_eps,count)
        empirical_tpm_og(ts,f_og,count)
